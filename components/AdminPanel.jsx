...
import SalesPerc from './SalesPerc';
...
const AdminPanel = () => {
    ...
    return (
        ...
        <main className='h-screen bg-black w-screen relative overflow-hidden'>
            ...
            <div className='absolute w-[15%] ml-[80%] h-[30%] mt-[-25%]'>
            <h1 className='text-green-400 text-xl font-bold mt-[130%] absolute'>Percentage</h1>
            <SalesPerc/>
            </div>
            ...
            <Link href='/userlist'>
                    <div className='bg-yellow-600 cursor-pointer absolute  lg:mt-0 ml-[53%] h-10 rounded-lg w-60'>
                        <h1 className='text-white font-bold text-xl absolute mt-1 ml-4 '>👤  User List</h1>
                    </div>
                </Link>
